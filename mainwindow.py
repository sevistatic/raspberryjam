...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.overlayToggle = QtWidgets.QPushButton(self.rightCol)
        self.overlayToggle.setText("Toggle Overlay")
        self.overlayToggle.setStyleSheet("QPushButton {background-color: light grey}")
